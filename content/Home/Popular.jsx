...
const Popular = () => {
  ...
  return (
    <div className="w-full max-w-[96rem] relative bottom-28 mx-5 mt-16 max-[1270px]:-mt-2 px-4 lg:px-0">
      {/* Responsive line with padding */}
      <div className="w-full h-px bg-gradient-to-r from-transparent via-[#39374b] to-transparent my-8"></div>
